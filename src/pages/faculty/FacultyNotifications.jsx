...
const FacultyNotifications = () => {
  ...
  const categories = ['All', 'Attendance', 'Pending Evaluation', 'Meeting', 'Review Cycle', 'General', 'System'];
  ...
  if (dataLoading) {
    return (
      <DashboardLayout navigationItems={facultyNavigation} title="Notifications">
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Updates on evaluations, team tracking, and pending reviews.</p>
          </div>
          {unreadCount > 0 && (
