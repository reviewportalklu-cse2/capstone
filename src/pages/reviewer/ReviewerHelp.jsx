...
const ReviewerHelp = () => {
  ...
  const faqs = [
    { q: "How do I evaluate a student?", a: "Navigate to the Assigned Students tab, locate the student, and click the Evaluate button. Alternatively, you can directly select Review 1/2/3 from the sidebar and select a student from the dropdown." },
    { q: "Can I evaluate students assigned to other reviewers?", a: "No, the system strictly enforces Role-Based Access Control. You can only evaluate students assigned to your workflow." },
    { q: "How does the Bulk Upload work?", a: "Go to the Bulk Upload Marks page, upload a CSV file with columns (studentid, reviewtype, presentation, technical, qa), review the parsed records, and click Import to save them to the database." },
    { q: "Can I edit a submitted review?", a: "No, once a review is finalized and submitted, it becomes immutable and automatically advances the student to the next review stage. If an error occurred, you must raise a support ticket with the administrator." }
  ];
  ...
  return (
    <DashboardLayout navigationItems={reviewerNavigation} title="KL CSE Capstone Portal - Help & Support">
