...
const StudentHelp = () => {
  ...
  const faqs = [
    { q: "How do I update my Project Repository link?", a: "Navigate to the My Project tab. Click 'Edit Details' in the top right corner of the Project Workspace card, update your GitHub/GitLab link, and save." },
    { q: "Where can I view my Review 1 marks?", a: "Your finalized review scores are published under the 'My Marks' tab. If you do not see them, your Reviewer has not finalized the evaluation yet." },
    { q: "Can I choose my own Guide?", a: "No, Guides are assigned administratively based on domain matching and faculty availability. You can view your assigned mentor under 'My Guide'." },
    { q: "How do I upload my Final Report?", a: "Go to the Downloads & Submissions tab. Under 'My Submissions', click the upload area to attach your final PDF. Ensure the file size is under the specified limit." }
  ];
    ...
    <DashboardLayout navigationItems={studentNavigation} title="CapstoneFlow - Help & Support">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Access FAQs, academic guidelines, or contact the university administration.</p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-primary-50 border-primary-100">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900">University Support Desk</h3>
                  <p className="text-sm text-gray-600 mt-1">support@capstoneflow.edu</p>
                </div>
              </div>
            </Card>
          </div>
