...
const GuideReports = () => {
  const { dashboardStats, getSupervisedTeams, dataLoading } = useGuideAnalytics();
  ...
  if (dataLoading) {
    return (
      <DashboardLayout navigationItems={guideNavigation} title="Analytics & Reports">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Exportable summaries of team progress and mentoring performance.</p>
          </div>
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              <StatCard 
                ...
                value={`${dashboardStats.averageTeamScore}/100`} 
                icon={CheckCircle2} 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card title="Guide Performance Summary">
                <div className="flex flex-col justify-center h-full space-y-4 p-4 text-sm text-gray-700 bg-gray-50 border border-gray-100 rounded-lg">
                  <p><strong>Guidance Load:</strong> Mentoring {dashboardStats.totalStudents} students across {dashboardStats.totalTeams} independent teams.</p>
                  <p><strong>Review Velocity:</strong> {dashboardStats.pendingEvaluations} pending evaluations in the current active review cycle.</p>
