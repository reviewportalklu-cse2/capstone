...
import { Loader2, Search, Users, ExternalLink, GraduationCap, AlertCircle, MessageSquare } from 'lucide-react';
...
const MyStudents = () => {
  ...
  const fetchStudents = async (guideId) => {
    try {
      setLoading(true);
      setError(null);
      const data = await studentService.getByGuideId(guideId);
      setStudents(data);
    } catch (err) {
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Manage and track students assigned to you for guidance.</p>
          </div>
        </div>
