  ...
  return (
    <footer className="w-full mt-auto border-t border-gray-200/80 dark:border-gray-800 bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm py-5 px-4 sm:px-6 md:px-8 text-xs transition-colors">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* Left Column: Branding Group & Tagline */}
        <div className="space-y-1">
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
            <span className="font-semibold text-gray-800 dark:text-gray-200 text-xs sm:text-sm tracking-tight">
            ...
            <a
              ...
              className="inline-flex items-center gap-1 font-semibold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 rounded-sm text-xs sm:text-sm"
            >
              View Portfolio &rarr;
            </a>
          </div>
        ...
        <div className="flex items-center pt-2 md:pt-0 border-t md:border-t-0 border-gray-200/60 dark:border-gray-800">
